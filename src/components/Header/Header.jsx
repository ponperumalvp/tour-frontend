...
const Header = () => {
  return (
    <header className="container w-[100%] h-[80px] border-b-2 flex flex-row items-center justify-between sticky top-[0] z-10 bg-gradient-to-r from-orange-300 via-white  to-slate-400 rounded-lg">
      <div className="">
